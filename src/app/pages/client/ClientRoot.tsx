              ...
              <Dialog>
                <Box direction="Column" gap="400" style={{ padding: config.space.S400 }}>
                  {loadState.status === AsyncStatus.Error && (
                    <Text>{t('app.failed_to_load', { message: loadState.error.message })}</Text>
                  )}
                  {startState.status === AsyncStatus.Error && (
                    <Text>{t('app.failed_to_start', { message: startState.error.message })}</Text>
                  )}
