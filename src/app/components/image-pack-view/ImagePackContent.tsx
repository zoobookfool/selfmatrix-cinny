    ...
    return (
      <Box grow="Yes" direction="Column" gap="700" {...props} ref={ref}>
            ...
            <Box alignItems="Center" gap="400">
              <Box grow="Yes" direction="Column">
                {applyState.status === AsyncStatus.Error ? (
                  <Text size="T200">
                    <b>{t('image_pack_view.content.apply_error')}</b>
                  </Text>
                ) : (
                  <Text size="T200">
                    <b>{t('image_pack_view.content.changes_saved')}</b>
                  </Text>
                )}
              </Box>
              <Box shrink="No" gap="200">
                ...
                >
                  <Text size="B300">{t('image_pack_view.content.reset_button')}</Text>
                </Button>
                <Button
                  size="300"
                  variant="Success"
                ...
                >
                  <Text size="B300">{t('image_pack_view.content.apply_changes_button')}</Text>
                </Button>
              </Box>
            </Box>
          </Menu>
        ...
        <Box direction="Column" gap="100">
          <Text size="L400">{t('image_pack_view.content.pack_heading')}</Text>
          <SequenceCard
            style={{ padding: config.space.S300 }}
          ...
          >
            <SettingTile
              title={t('image_pack_view.content.usage_title')}
              description={t('image_pack_view.content.usage_description')}
              after={
                <UsageSwitcher
        ...
        {images.length === 0 && !canEdit ? null : (
          <Box direction="Column" gap="100">
            <Text size="L400">{t('image_pack_view.content.images_heading')}</Text>
            {canEdit && (
              <SequenceCard
                style={{ padding: config.space.S300 }}
                variant="SurfaceVariant"
              ...
              >
                <SettingTile
                  title={t('image_pack_view.content.upload_title')}
                  description={t('image_pack_view.content.upload_description')}
                  after={
                    <Button
                      variant="Secondary"
                      fill="Soft"
                    ...
                    >
                      <Text size="B300">{t('image_pack_view.content.select_button')}</Text>
                    </Button>
                  }
                />
              </SequenceCard>
