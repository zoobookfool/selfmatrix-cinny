...
export const useCommands = (mx: MatrixClient, room: Room): CommandRecord => {
  ...
  const commands: CommandRecord = useMemo(
    () => ({
      [Command.Me]: {
        name: Command.Me,
        description: t('commands.me.description'),
        exe: async () => undefined,
      },
      [Command.Notice]: {
        name: Command.Notice,
        description: t('commands.notice.description'),
        exe: async () => undefined,
      },
      [Command.Shrug]: {
        name: Command.Shrug,
        description: t('commands.shrug.description', { shrug: SHRUG }),
        exe: async () => undefined,
      },
      [Command.TableFlip]: {
        name: Command.TableFlip,
        description: t('commands.tableflip.description', { tableflip: TABLEFLIP }),
        exe: async () => undefined,
      },
      [Command.UnFlip]: {
        name: Command.UnFlip,
        description: t('commands.unflip.description', { unflip: UNFLIP }),
        exe: async () => undefined,
      },
      [Command.StartDm]: {
        name: Command.StartDm,
        description: t('commands.startdm.description'),
        exe: async (payload) => {
      ...
      [Command.Leave]: {
        name: Command.Leave,
        description: t('commands.leave.description'),
        exe: async (payload) => {
          if (payload.trim() === '') {
      ...
      [Command.Invite]: {
        name: Command.Invite,
        description: t('commands.invite.description'),
        exe: async (payload) => {
      ...
      [Command.DisInvite]: {
        ...
        description: t('commands.disinvite.description'),
        exe: async (payload) => {
          const [content, flags] = splitPayloadContentAndFlags(payload);
          const users = parseUsers(content);
          const flagToContent = parseFlags(flags);
      ...
      [Command.Ban]: {
        name: Command.Ban,
        description: t('commands.ban.description'),
        exe: async (payload) => {
          const [content, flags] = splitPayloadContentAndFlags(payload);
          const users = parseUsers(content);
          const servers = parseServers(content);
      ...
      [Command.UnBan]: {
        name: Command.UnBan,
        description: t('commands.unban.description'),
        exe: async (payload) => {
          const rawIds = splitWithSpace(payload);
      ...
      [Command.UnIgnore]: {
        ...
        description: t('commands.unignore.description'),
        exe: async (payload) => {
          const rawIds = splitWithSpace(payload);
          const userIds = rawIds.filter((id) => isUserId(id));
          if (userIds.length > 0) {
      ...
      [Command.MyRoomNick]: {
        ...
        description: t('commands.myroomnick.description'),
        exe: async (payload) => {
      ...
      [Command.MyRoomAvatar]: {
        ...
        description: t('commands.myroomavatar.description'),
        exe: async (payload) => {
      ...
      [Command.ConvertToDm]: {
        ...
        description: t('commands.converttodm.description'),
        exe: async () => {
      ...
      [Command.ConvertToRoom]: {
        ...
        description: t('commands.converttoroom.description'),
        exe: async () => {
      ...
      [Command.Acl]: {
        name: Command.Acl,
        description: t('commands.acl.description'),
        exe: async (payload) => {
    ...
    [mx, room, navigateRoom, t, i18n.language]
  );
