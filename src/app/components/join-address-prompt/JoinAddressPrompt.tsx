      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{t('join_address.title')}</Text>
              </Box>
            ...
            >
              ...
              <Box direction="Column" gap="100">
                <Text size="L400">{t('join_address.address_label')}</Text>
                <Input
                  size="500"
                  autoFocus
                  name="addressInput"
                  variant="Background"
                  placeholder={t('join_address.address_placeholder')}
                  required
                />
                {invalid && (
                  <Text size="T200" style={{ color: color.Critical.Main }}>
                    <b>{t('join_address.invalid_address')}</b>
                  </Text>
                )}
              </Box>
              <Button type="submit" variant="Primary">
                <Text size="B400">{t('join_address.open_button')}</Text>
              </Button>
            </Box>
          </Dialog>
        </FocusTrap>
