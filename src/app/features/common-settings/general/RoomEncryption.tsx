...
export function RoomEncryption({ permissions }: RoomEncryptionProps) {
  ...
  return (
    ...
    >
      <SettingTile
        title={t('room_settings.general.encryption.title')}
        description={
          enabled
            ? t('room_settings.general.encryption.enabled_description')
            : t('room_settings.general.encryption.disabled_description')
        }
        after={
          enabled ? (
            <Badge size="500" variant="Success" fill="Solid" radii="300">
              <Text size="L400">{t('room_settings.general.encryption.enabled_badge')}</Text>
            </Badge>
          ) : (
            <Button
              size="300"
            ...
            >
              <Text size="B300">{t('room_settings.general.encryption.enable_button')}</Text>
            </Button>
          )
        }
      >
            ...
            <OverlayCenter>
              ...
              >
                <Dialog variant="Surface">
                  ...
                  >
                    <Box grow="Yes">
                      <Text size="H4">{t('room_settings.general.encryption.dialog_title')}</Text>
                    </Box>
                  ...
                  <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
                    <Text priority="400">
                      {t('room_settings.general.encryption.dialog_confirm')}
                    </Text>
                    <Button type="submit" variant="Primary" onClick={handleEnable}>
                      <Text size="B400">{t('room_settings.general.encryption.dialog_enable_button')}</Text>
                    </Button>
                  </Box>
                </Dialog>
              </FocusTrap>
