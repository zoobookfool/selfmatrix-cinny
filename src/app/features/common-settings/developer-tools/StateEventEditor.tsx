  ...
  return (
    ...
    >
      <Box shrink="No" direction="Column" gap="100">
        <Text size="L400">{t('room_settings.developer_tools.state_event_title')}</Text>
        <SequenceCard
          ...
          <SettingTile
            ...
            after={
              <Box gap="200">
                ...
                >
                  <Text size="B300">{t('room_settings.developer_tools.save_button')}</Text>
                </Button>
                <Button
                  variant="Secondary"
                  fill="Soft"
                  ...
                  disabled={submitting}
                >
                  <Text size="B300">{t('room_settings.developer_tools.cancel_button')}</Text>
                </Button>
              </Box>
            }
          />
      ...
      <Box grow="Yes" direction="Column" gap="100">
        <Box shrink="No">
          <Text size="L400">{t('room_settings.developer_tools.json_content_label')}</Text>
        </Box>
        <TextAreaComponent
          ref={textAreaRef}
        ...
        <Box gap="200" alignItems="End">
          ...
          {onEditContent && (
            <Box shrink="No" gap="200">
              ...
              >
                <Text size="B300">{t('room_settings.developer_tools.edit_button')}</Text>
              </Chip>
            </Box>
          )}
        </Box>
      ...
      <PageHeader outlined={false} balance>
        <Box alignItems="Center" grow="Yes" gap="200">
          <Box alignItems="Inherit" grow="Yes" gap="200">
            ...
            >
              <Text size="T300">{t('room_settings.developer_tools.title')}</Text>
            </Chip>
          </Box>
          <Box shrink="No">
