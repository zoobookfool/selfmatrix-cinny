      ...
      <Box grow="Yes" direction="Column">
        ...
        >
          <Box shrink="No" direction="Column" gap="100">
            <Text size="L400">
              {composeStateEvent
                ? t('room_settings.developer_tools.state_event_type_label')
                : t('room_settings.developer_tools.message_event_type_label')}
            </Text>
            <Box gap="300">
              <Box grow="Yes" direction="Column">
                <Input
              ...
              >
                <Text size="B400">{t('room_settings.developer_tools.send_button')}</Text>
              </Button>
            </Box>
          ...
          {composeStateEvent && (
            <Box shrink="No" direction="Column" gap="100">
              <Text size="L400">{t('room_settings.developer_tools.state_key_optional_label')}</Text>
              <Input
                variant="Background"
                name="stateKeyInput"
                size="400"
