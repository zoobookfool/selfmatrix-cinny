  ...
  return (
    <Box as="form" onSubmit={handleSubmit} gap="200" aria-disabled={ignoring}>
      ...
      >
        ...
        <Text size="B400">{t('settings.account.ignored_users.block_button')}</Text>
      </Button>
    </Box>
  );
}
  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.account.ignored_users.title')}</Text>
      </Box>
      <SequenceCard
      ...
      >
        <SettingTile
          title={t('settings.account.ignored_users.select_user_title')}
          description={t('settings.account.ignored_users.select_user_description')}
        >
          <Box direction="Column" gap="300">
            <IgnoreUserInput userList={ignoredUsers} />
            {ignoredUsers.length > 0 && (
              <Box direction="Inherit" gap="100">
                <Text size="L400">{t('settings.account.ignored_users.users_label')}</Text>
