  ...
  return (
    ...
    >
      <SettingTile
        title={
          room.isSpaceRoom()
            ? t('room_settings.general.join_rules.title_space')
            : t('room_settings.general.join_rules.title_room')
        }
        description={
          room.isSpaceRoom()
            ? t('room_settings.general.join_rules.description_space')
            : t('room_settings.general.join_rules.description_room')
        }
        after={
          <JoinRulesSwitcher
            icons={icons}
