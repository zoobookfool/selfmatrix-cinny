  ...
  return (
    ...
    >
      <Box shrink="No" direction="Column" gap="100">
        <Text size="L400">{t('account_data_editor.account_data_label')}</Text>
        <Box gap="300">
          ...
          >
            <Text size="B400">{t('account_data_editor.save_button')}</Text>
          </Button>
          <Button
            variant="Secondary"
            fill="Soft"
            ...
            disabled={submitting}
          >
            <Text size="B400">{t('account_data_editor.cancel_button')}</Text>
          </Button>
        </Box>
      ...
      <Box grow="Yes" direction="Column" gap="100">
        <Box shrink="No">
          <Text size="L400">{t('account_data_editor.json_content_label')}</Text>
        </Box>
        <TextAreaComponent
          ref={textAreaRef}
    ...
    >
      <Box shrink="No" gap="300" alignItems="End">
        ...
        <Button variant="Secondary" size="400" radii="300" onClick={onEdit}>
          <Text size="B400">{t('account_data_editor.edit_button')}</Text>
        </Button>
      </Box>
      <Box grow="Yes" direction="Column" gap="100">
        <Text size="L400">{t('account_data_editor.json_content_label')}</Text>
      ...
      <PageHeader outlined={false} balance>
        <Box alignItems="Center" grow="Yes" gap="200">
          <Box alignItems="Inherit" grow="Yes" gap="200">
            ...
            >
              <Text size="T300">{t('account_data_editor.developer_tools_label')}</Text>
            </Chip>
          </Box>
          <Box shrink="No">
