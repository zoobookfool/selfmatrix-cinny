  ...
  return (
    <Header size="400">
      ...
      >
        ...
        <Text size="H6">{t('upload_board.files')}</Text>
      </Box>
      <Box className={css.UploadBoardHeaderContent} alignItems="Center" gap="100">
        {isSuccess && (
          ...
          >
            <Text size="B300">{t('upload_board.send')}</Text>
          </Chip>
        )}
        {isError && !open && (
          <Badge variant="Critical" fill="Solid" radii="300">
            <Text size="L400">{t('upload_board.upload_failed')}</Text>
          </Badge>
        )}
        ...
        {!isSuccess && open && (
          ...
          >
            <Text size="B300">
              {uploads.length === 1 ? t('upload_board.remove') : t('upload_board.remove_all')}
            </Text>
          </Chip>
        )}
      </Box>
