      ...
      after={
        canEdit ? (
          <Box shrink="No" alignItems="Center" gap="200">
            ...
            >
              {deleted ? (
                <Text size="B300">{t('image_pack_view.image_tile.undo_button')}</Text>
              ) : (
            ...
            {!deleted && (
              ...
              >
                <Text size="B300">{t('image_pack_view.image_tile.edit_button')}</Text>
              </Chip>
            )}
          </Box>
        ) : undefined
    ...
    >
      <Box as="form" onSubmit={handleSubmit} direction="Column" gap="200">
        <Box direction="Column" className={css.ImagePackImageInputs}>
          <Input
            before={<Text size="L400">{t('image_pack_view.image_tile.shortcode_label')}</Text>}
          ...
          />
          <Input
            before={<Text size="L400">{t('image_pack_view.image_tile.body_label')}</Text>}
        ...
        <Box gap="200">
          ...
          <Button type="submit" variant="Success" size="300" radii="300">
            <Text size="B300">{t('image_pack_view.image_tile.save_button')}</Text>
          </Button>
          <Button
            type="reset"
            variant="Secondary"
          ...
          >
            <Text size="B300">{t('image_pack_view.image_tile.cancel_button')}</Text>
          </Button>
        </Box>
      </Box>
    </SettingTile>
