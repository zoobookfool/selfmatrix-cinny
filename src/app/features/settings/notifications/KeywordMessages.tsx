  ...
  return (
    <Box as="form" onSubmit={handleSubmit} gap="200" aria-disabled={addingKeyword}>
      ...
      >
        ...
        <Text size="B400">{t('settings.notifications.keyword.save_button')}</Text>
      </Button>
    </Box>
  );
}
  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.notifications.keyword.section_label')}</Text>
        <Box gap="100">
      ...
      >
        <SettingTile
          title={t('settings.notifications.keyword.select_title')}
          description={t('settings.notifications.keyword.select_description')}
        >
          <KeywordInput />
        </SettingTile>
      </SequenceCard>
      {keywordPushRules.map((pushRule) => (
        ...
        >
          <SettingTile
            title={t('settings.notifications.keyword.pattern_title', {
