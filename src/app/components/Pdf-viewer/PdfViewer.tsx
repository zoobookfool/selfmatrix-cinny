      ...
      <Box className={classNames(css.PdfViewer, className)} direction="Column" {...props} ref={ref}>
        <Header className={css.PdfViewerHeader} size="400">
          ...
          <Box shrink="No" alignItems="Center" gap="200">
            ...
            >
              <Text size="B300">{t('viewer.pdf_viewer.download')}</Text>
            </Chip>
          </Box>
        </Header>
        <Box direction="Column" grow="Yes" alignItems="Center" justifyContent="Center" gap="200">
          ...
          {isError && (
            <>
              <Text>{t('viewer.pdf_viewer.failed_to_load')}</Text>
              <Button
                variant="Critical"
                fill="Soft"
                size="300"
                ...
                onClick={loadPdfJS}
              >
                <Text size="B300">{t('viewer.pdf_viewer.retry')}</Text>
              </Button>
            </>
          )}
        ...
        {docState.status === AsyncStatus.Success && (
          <Header as="footer" className={css.PdfViewerFooter} size="400">
            ...
            >
              <Text size="B300">{t('viewer.pdf_viewer.previous')}</Text>
            </Chip>
                    ...
                    <Menu variant="Surface">
                      ...
                      >
                        ...
                        <Button type="submit" size="300" variant="Primary" radii="300">
                          <Text size="B300">{t('viewer.pdf_viewer.jump_to_page')}</Text>
                        </Button>
                      </Box>
                    </Menu>
                  </FocusTrap>
            ...
            >
              <Text size="B300">{t('viewer.pdf_viewer.next')}</Text>
            </Chip>
          </Header>
        )}
      </Box>
