...
export function ContactInformation() {
  ...
  return (
    <Box direction="Column" gap="100">
      <Text size="L400">{t('settings.account.contact_info.title')}</Text>
      <SequenceCard
      ...
      >
        <SettingTile
          title={t('settings.account.contact_info.email_title')}
          description={t('settings.account.contact_info.email_description')}
        >
          <Box>
            {emailIds?.map((email) => (
