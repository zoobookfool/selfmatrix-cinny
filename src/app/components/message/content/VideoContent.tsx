      ...
      <Box className={classNames(css.RelativeBase, className)} {...props} ref={ref}>
        ...
        {!autoPlay && !blurred && srcState.status === AsyncStatus.Idle && (
          <Box className={css.AbsoluteContainer} alignItems="Center" justifyContent="Center">
            ...
            >
              <Text size="B300">{t('message.video_content.watch')}</Text>
            </Button>
          </Box>
        )}
          ...
          <Box className={css.AbsoluteContainer} alignItems="Center" justifyContent="Center">
            ...
            >
              {(triggerRef) => (
                ...
                >
                  <Text size="B300">{t('message.video_content.spoiler')}</Text>
                </Chip>
              )}
            </TooltipProvider>
          </Box>
          ...
          <Box className={css.AbsoluteContainer} alignItems="Center" justifyContent="Center">
            <TooltipProvider
              tooltip={
                <Tooltip variant="Critical">
                  <Text>{t('message.video_content.failed_to_load')}</Text>
                </Tooltip>
              }
              position="Top"
              align="Center"
            >
              {(triggerRef) => (
                ...
                >
                  <Text size="B300">{t('message.video_content.retry')}</Text>
                </Button>
              )}
            </TooltipProvider>
          </Box>
