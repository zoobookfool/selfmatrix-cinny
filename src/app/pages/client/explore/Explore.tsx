        ...
        <OverlayCenter>
          ...
          >
            <Dialog variant="Surface">
              ...
              >
                <Box grow="Yes">
                  <Text size="H4">{t('explore.add_server.title')}</Text>
                </Box>
              ...
              <Box
                ...
                gap="400"
              >
                <Text priority="400">{t('explore.add_server.description')}</Text>
                <Box direction="Column" gap="100">
                  <Text size="L400">{t('explore.add_server.server_name_label')}</Text>
                  <Input ref={serverInputRef} name="serverInput" variant="Background" required />
                  {exploreState.status === AsyncStatus.Error && (
                    <Text style={{ color: color.Critical.Main }} size="T300">
                      {t('explore.add_server.load_error')}
                    </Text>
                  )}
                </Box>
                <Box direction="Column" gap="200">
                  ...
                  <Button type="submit" onClick={handleView} variant="Secondary" fill="Soft">
                    <Text size="B400">{t('explore.add_server.view_button')}</Text>
                  </Button>
                </Box>
              </Box>
            </Dialog>
