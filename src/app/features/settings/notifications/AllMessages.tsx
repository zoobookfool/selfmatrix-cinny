  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.notifications.all_messages.section_label')}</Text>
        <Box gap="100">
      ...
      >
        <SettingTile
          title={t('settings.notifications.all_messages.dm_title')}
      ...
      >
        <SettingTile
          title={t('settings.notifications.all_messages.dm_encrypted_title')}
          after={
      ...
      >
        <SettingTile
          title={t('settings.notifications.all_messages.rooms_title')}
      ...
      >
        <SettingTile
          title={t('settings.notifications.all_messages.rooms_encrypted_title')}
          after={
            <AllMessagesModeSwitcher
              pushRules={pushRules}
