              ...
              <Box direction="Column" gap="200">
                <PageHeroSection>
                  <PageHero
                    ...
                    subTitle={t('explore.featured.sub_title')}
                  />
                </PageHeroSection>
                <Box direction="Column" gap="700">
                  {spaces && spaces.length > 0 && (
                    <Box direction="Column" gap="400">
                      <Text size="H4">{t('explore.featured.spaces_heading')}</Text>
                      <RoomCardGrid>
                  ...
                  {rooms && rooms.length > 0 && (
                    <Box direction="Column" gap="400">
                      <Text size="H4">{t('explore.featured.rooms_heading')}</Text>
                      <RoomCardGrid>
